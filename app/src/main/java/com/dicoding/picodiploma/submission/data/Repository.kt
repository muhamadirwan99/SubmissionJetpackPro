            ...
            override fun onMoviesLoaded(movies: List<Movie>?) {
                ...
                if (movies != null){
                    for (response in movies) {
                        with(response) {
                            val movie = DataEntity(id, title, releaseDate, null, posterPath, null, null, overview, null, voteAverage)
                            movieList.add(movie)
                        }
                    }
            ...
            override fun onDetailMovieLoaded(movieDetail: MovieDetailResponse?) {
                if (movieDetail != null) {
                    with(movieDetail) {
                        ...
                        val detailMovie = DataEntity(id, title, releaseDate, runtime, posterPath, listGenre, status, overview, null, voteAverage)
            ...
            override fun onTvShowsLoaded(tvShows: List<TvShow>?) {
                ...
                if (tvShows != null) {
                    for (response in tvShows) {
                        with(response) {
                            val tvShow = DataEntity(id, name, firstAirDate, null, posterPath, null, null, overview, null, voteAverage)
            ...
            override fun onDetailTvShowLoaded(tvShowDetail: TvShowDetailResponse?) {
                if (tvShowDetail != null) {
                    with(tvShowDetail) {
                        ...
                        val detailTvShow = DataEntity(id, name, firstAirDate, null, posterPath, listGenre, status, overview, null, voteAverage)
